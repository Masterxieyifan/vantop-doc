## PageList 列表页模版
基于[el-tabs](https://element.eleme.cn/#/zh-CN/component/tabs#events)开发
...
```html
<template>
    <div class="md-page-list-example">
        <md-page-list
    ...
    export default {
        ...
        mounted(){
            setTimeout(() => {
                ...
                this.pageConfig.pageUpdateTime = '2021-08-15 10:00:01';
            }, 2000)
        },
    }
</script>
    ...
    export default {
        ...
        methods: {
            ...
            handleTabClick(tab){
                ...
                this.$refs.PageList.updateFilterStatusNum(1, 100); // 1 -> filterStatus.tabs 的索引，100 -> 值
            },
            handle(item){
                this.query.status = '';
                // 修改 filterStatus 的 默认赋值
                this.$refs.PageList.updateFilterStatusDefault();
            },
        }
    }
</script>
...
<script>
    export default {
        data() {
            return {
                pageConfig: {
                    skeleton: false, // 不显示 骨架屏
                    padding: 0, // 页面 左右padding
                },
                // table
                columns: [
                    { prop: 'name', label: '名称', },
...
| pageHelp  | 页面 跳转帮助中心, 为 false 则不显示  | Function / Boolean|否      |-      |
| pageRefresh         | 页面 刷新, 为 false 则不显示        | Function / Boolean|否      |-      |
...
| displayBtnsNum      | 页面 操作按钮 个数 | String  |否      |无      |
