...
:::demo 使用 `el-checkbox-more` 复选框配合 `label-width` 属性配置可以实现文本溢出自动省略且悬浮提示功能
```html
<template>
  <div>
    <el-checkbox-more
        v-model="checked2"
        label-width="auto"
        label="会根据长度自动判断的。。会根据长度自动判断的。。会根据长度自动判断的。。会根据长度自动判断的。。设置了label-width='auto'"
    />
    <el-checkbox-more
        v-model="checked3"
        :label-width="100"
        label="会根据长度自动判断的label-width='auto'"
    />
    <el-checkbox-more
        border
        style="width: 150px;"
        v-model="checked1"
        :label-width="100"
        label="这是一个checkbox带隐藏着更多的信息，设置了label-width"
    />
  </div>
</template>
    ...
    <el-row :gutter="24">
      ...
      <el-col :span="6">
        <el-checkbox-more
            v-model="checked1"
            label-width="auto"
            label="这也是一个自动隐藏长度的东东哦。。"
        />
      </el-col>
      <el-col :span="6">
        <el-checkbox-more
            v-model="checked3"
            label="这是没有设置lable-width的"
        />
      </el-col>
    </el-row>
    <el-row :gutter="24" style="margin-top: 20px;">
      <el-col :span="6">
        <el-checkbox-more
            ...
            v-model="checked1"
            :label-width="120"
            label="超长省略文本超长省略文本超长省略文本超长省略文本超长省略文本"
        />
      </el-col>
      <el-col :span="6">
        <el-checkbox-more
