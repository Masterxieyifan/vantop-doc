 ...
 * @Date: 2022-04-14 14:23:48
 * @LastEditors: lingyong.zeng
 * @LastEditTime: 2022-04-14 14:23:49
 * @Description: 
 * @FilePath: /vantop-docs/src/views/vanlement-ui/drawer copy.md
-->
## Drawer 抽屉
...
### 定位参照
指定 **父级** 某个 DOM 元素为定位参照物

:::demo 

```html
<div 
  class="pos-refer-target-box" 
>
  相对于父级容器定位 <br/>
  <el-button 
  ...
  <el-drawer
    pos-refer-target=".pos-refer-target-box"
    :visible.sync="drawer"
    :with-header="false"
    :modal-append-to-body="false"
  >
    <span>我相对于父元素<br/> .pos-refer-target-box 定位</span>
  </el-drawer>
</div>
...
<el-dialog
  class="posReferDialog"
  title="Drawer相较于Dialog定位"
...
>
  ...
  <el-drawer
    size="50%"
    pos-refer-target=".posReferDialog .el-dialog"
    :visible.sync="drawerVisible"
    :with-header="false"
    :modal-append-to-body="false"
    @cancel="drawerVisbile=false"
  >
    <span>我相对于 dialog 中的 body 定位</span>
    <br/>
    <el-button
      type="text" 
...
| withFooter | 控制是否显示 footer 栏, 默认为 true | boolean | - | false |
| posReferTarget | 定位所参照的父级元素(el 选择器)，如需遮罩层，需配合 modal-append-to-body 为 false | string | - | -
